...
export function NetBalanceCard({ balanceBs, balanceUsd, zone, summary }: NetBalanceCardProps) {
  ...
  return (
    <View className="rounded-[18px] border border-borde-suave bg-superficie p-5">
      <View className="mb-2.5 flex-row items-start justify-between">
        <Text className="font-mono text-[10px] tracking-[1.2px] text-texto-suave">SALDO NETO</Text>
        <View className="rounded-full border border-borde-suave px-2.5 py-[3px]">
          <Text className="text-[10px] font-heading-semibold text-texto">Zona: {zone}</Text>
        </View>
      </View>

      <Text
        className="text-[38px] font-heading-bold tracking-[-0.4px]"
        style={{ color: balanceColor }}
      >
        {formatBs(balanceBs)}
      </Text>
      <Text className="mt-0.5 text-[13px] font-heading-semibold text-texto-suave">
        {formatRef(balanceUsd)}
      </Text>

      <View className="mt-3 flex-row gap-[18px] border-t border-borde-suave pt-3">
        <View>
          <Text className="font-mono text-[9px] text-texto-suave">GANADO</Text>
          <Text
            className="text-[14px] font-heading-semibold"
        ...
        <View>
          <Text className="font-mono text-[9px] text-texto-suave">DESCONTADO</Text>
          <Text
            className="text-[14px] font-heading-semibold"
