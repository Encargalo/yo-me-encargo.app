...
7. **Verificar rama git y tarea en gestor externo**
   ...
   b. *(Solo si `taskManager` está en config)* Buscar la tarea del change en el gestor externo para recuperar su ID — se necesita al final para marcarla como "En revision" cuando se archive.
...
- La rama git y la tarea del gestor las crea `/opsx:propose` — este skill solo las verifica
