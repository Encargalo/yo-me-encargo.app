---
name: openspec-live-edit
description: Modo de edición en vivo — fusiona explore y apply en un solo flujo continuo para sesiones de pair-programming donde hay que investigar y editar código en la marcha. Al cerrar la sesión, reconstruye automáticamente el proposal/design/tasks de OpenSpec con todo lo que ya se hizo y archiva el change. Usar cuando el usuario quiere iterar rápido sin pasar por propose → apply → archive paso a paso.
license: MIT
